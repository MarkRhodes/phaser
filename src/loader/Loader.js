...
Phaser.Loader.prototype = {
    ...
    * @return {Phaser.Loader} This Loader instance.
    */
    atlasJSONHash: function (key, textureURL, atlasURL, atlasData, scaleFactor) {

        return this.atlas(key, textureURL, atlasURL, atlasData, Phaser.Loader.TEXTURE_ATLAS_JSON_HASH, scaleFactor);
    ...
    * @return {Phaser.Loader} This Loader instance.
    */
    atlas: function (key, textureURL, atlasURL, atlasData, format, scaleFactor) {
        ...
        if (atlasURL)
        {
            this.addToFileList('textureatlas', key, textureURL, { atlasURL: atlasURL, format: format, scaleFactor: scaleFactor });
        }
        else
        {
            switch (format)
            ...
            this.addToFileList('textureatlas', key, textureURL, { atlasURL: null, atlasData: atlasData, format: format, scaleFactor: scaleFactor  });
        ...
        switch (file.type)
        {
            ...
            case 'bitmapfont':
                ...
                file.data.onload = function () {
                    if (file.scaleFactor && file.scaleFactor !== 1) {
                        file.data = _this._scaleImage(file.data, file.scaleFactor);
                    }
    ...
    */
    jsonLoadComplete: function (index) {
        ...
        {
            this.game.cache.addTextureAtlas(file.key, file.url, file.data, data, file.format, file.scaleFactor);
        }
